...
def main(
    ...
    with open(save_paths['json'].joinpath('data.json'), 'w') as f:
        total_json_tree = total_json_tree.replace('data = ', '')
        total_json_tree = json.loads(total_json_tree)
        json.dump(total_json_tree, f)
